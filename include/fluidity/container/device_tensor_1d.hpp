//==--- fluidity/container/device_tensor_1d.hpp ------------ -*- C++ -*- ---==//
//            
//                                Fluidity
// 
...
//==------------------------------------------------------------------------==//
//
/// \file  device_tensor_1d.hpp
/// \brief This file defines a file which implements device (GPU) side tensor
///        functionality for a one dimensional tensor.
//
//==------------------------------------------------------------------------==//

#ifndef FLUIDITY_CONTAINER_DEVICE_TENSOR_1D_HPP
#define FLUIDITY_CONTAINER_DEVICE_TENSOR_1D_HPP
...
: BaseTensor<T, 1>(host_tensor.total_size())
{
  allocate();
...
#endif // FLUIDITY_CONTAINER_DEVICE_TENSOR_1D_HPP