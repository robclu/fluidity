...
#include <fluidity/reconstruction/reconstructor_traits.hpp>
...
struct SimulationTraits {
 ...
 public:
  ...
  /// Defines the traits of the reconstuctor.
  using recon_traits_t  = recon::ReconstructorTraits<reconstructor_t>;
  ...
  using loader_t        = solver::BoundaryLoader<recon_traits_t::width>;
