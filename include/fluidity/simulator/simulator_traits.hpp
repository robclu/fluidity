//==--- fluidity/simulator/simulator_traits.hpp ------------ -*- C++ -*- ---==//
//            
//                                Fluidity
// 
...
//==------------------------------------------------------------------------==//
//
/// \file  simulator_traits.hpp
/// \brief This file provides traits for the simulator implementation.
//
//==------------------------------------------------------------------------==//

#ifndef FLUIDITY_SIMULATOR_SIMULATOR_TRAITS_HPP
#define FLUIDITY_SIMULATOR_SIMULATOR_TRAITS_HPP
...
/// Defines traits for a simulator implementation.
...
struct SimTraits {
  ...
  using def_limiter_t = limit::VanLeer<def_form_t>;
...
#endif // FLUIDITY_SIMULATOR_SIMULATOR_TRAITS_HPP