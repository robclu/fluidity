...
TEST(dimension_info_ct_tests_host, sizes_compute_correctly)
{
...
TEST(dimension_info_ct_tests_host, total_size_computes_correctly)
{
...
TEST(dimension_info_ct_tests_host, can_get_flattened_indices)
{
...
TEST(dimension_info_tests_host, can_get_flattened_indices)
{
  constexpr auto size_x = 3, size_y = 3, size_z = 2;
  using dim_info_t = fluid::DimInfo;
