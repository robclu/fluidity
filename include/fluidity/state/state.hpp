...
/// Prints the contents of the state.
fluidity_host_device void print() const
{
  print_impl(Dimension<dimensions>{}, dispatch_tag_t{});
}
...
/// Implementation of the print functionality for a 1D primitive state. 
fluidity_host_device void
print_impl(Dimension<1>, traits::primitive_tag_t) const
{
  printf("\n\tdensity    : %5.5f\n"
           "\tpressure   : %5.5f\n"
           "\tvelocity_x : %5.5f\n\n",
...
/// Implementation of the print functionality for a 1D conservative state.
fluidity_host_device void
print_impl(Dimension<1>, traits::conservative_tag_t) const
{
  printf("\n\tdensity            : %5.5f\n"
           "\tenergy             : %5.5f\n"
           "\tdensity_velocity_x : %5.5f\n\n",
         this->operator[](0),
         this->operator[](1),
         this->operator[](2));
} 
