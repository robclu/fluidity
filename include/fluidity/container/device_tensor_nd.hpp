//==--- fluidity/container/device_tensor_nd.hpp ------------ -*- C++ -*- ---==//
//            
//                                Fluidity
// 
...
//==--- DeviceTensor ND Specialization -------------------------------------==//
...
//==--- DeviceTensor ND Implementation -------------------------------------==//
...
template <typename T, std::size_t N>
DeviceTensor<T, N>::DeviceTensor(const host_t& host_tensor)
: base_t{host_tensor}
{
  allocate();
...
#endif // FLUIDITY_CONTAINER_DEVICE_TENSOR_ND_HPP